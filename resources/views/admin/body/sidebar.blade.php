            ...
            <li  class="has-sub" >
              ...
              <ul  class="collapse"  id="charts"
                ...
                <div class="sub-menu">
                      ...
                      <li >
                        <a class="sidenav-item-link" href="{{route('Chart.js')}}">
            ...
            <li  class="has-sub" >
              ...
              <ul  class="collapse"  id="pages"
                ...
                <div class="sub-menu">
                      ...
                      <li >
                        <a class="sidenav-item-link" href="{{route('our.team')}}">
                          <span class="nav-text">Our Team</span>
                          
                        </a>
                      </li>
                      <li >
                        <a class="sidenav-item-link" href="{{route('team.skills')}}">
                          <span class="nav-text">Team Skills</span>
                          
                        </a>
                      </li>
                      <li >
                        <a class="sidenav-item-link" href="{{route('Pricing.index')}}">
