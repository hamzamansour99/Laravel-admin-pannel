...
<form action="{{url('brand/update/'.$brands->id)}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label for="exampleInputEmail1">Update Brand Details </label>
      <textarea name="brand_details" class="form-control" id="exampleInputEmail1"aria-describedby="emailHelp"> {{$brands->brand_details}} </textarea>
