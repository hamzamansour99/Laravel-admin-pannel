        ...
        <div class="card-body">
            <form action="{{route('store.skill')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="skill" class="form-control" id="exampleFormControlInput1" placeholder="Enter Title">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Skill Percentage</label>
                    <input type="number" name="percentage" class="form-control" id="exampleFormControlInput1" placeholder="Enter Skill percentage">
                </div>
