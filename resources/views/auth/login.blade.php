            ...
            <div class="card-header" style="background-color: black"  >
              <div class="app-brand" style="background-color: black">
                <a href="/index.html">
                  ...
                  <span class="brand-name"> Sign In</span>
                </a>
              </div>
            </div>
            @if (session('success'))
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="d-flex my-2 justify-content-between">
                      ...
                      <p><a class="text-dark" href="{{ route('password.request') }}">Forgot Your Password?</a></p>
                    </div>
                    <button type="submit" class="btn btn-success" style="background-color:#1BBD36;">Sign In</button>
                    <p>Don't have an account yet ?
                      <a class="btn btn-success" style="background-color:#1BBD36;" href="{{ route('register') }}">Sign Up</a>
                    </p>
                  </div>
                </div>
              </form>
