...
<head>
  ...
  <body class="bg-light-gray" id="body">
          ...
          <div class="row justify-content-center mt-5">
            <div class="col-xl-5 col-lg-6 col-md-10" style="margin-top:20px;"  >
              <div class="card" >
                ...
                <div class="card-body p-5">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12 mb-4">
                        <input type="text" class="form-control input-lg"  aria-describedby="nameHelp" name="name" placeholder="Name">
                      </div>
                      <div class="form-group col-md-12 mb-4">
                      ...
                      <div class="col-md-12">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary btn-block mb-4" style="background-color:#1BBD36;">Sign Up</button>
                        <p>Already have an account?
                          <a class="txt" style="color:#1BBD36;" href="{{ route('login') }}">Sign in</a>
                        </p>
                      </div>
                    </div>
                  </form>
